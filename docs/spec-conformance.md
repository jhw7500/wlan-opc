...
5. **D8·D9·D10·D11 — 에러코드 불일치**
   ...
   - **D9 재정정(2026-06-16):** apply 런타임 실패는 사양에 코드가 없어 0x0011(입력 주파수) 근사 대신 **전용 0x0050 재도입(발주처 확인 대기)** + 실패 시 last-good 재적용(원자성). D10은 사양 정의값 0x0012로 정확 정정
